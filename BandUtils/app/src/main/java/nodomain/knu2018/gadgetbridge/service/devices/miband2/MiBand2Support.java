...
package nodomain.knu2018.gadgetbridge.service.devices.miband2;
...
import nodomain.knu2018.gadgetbridge.Logging;
import nodomain.knu2018.gadgetbridge.R;
import nodomain.knu2018.gadgetbridge.activities.SettingsActivity;
import nodomain.knu2018.gadgetbridge.database.DBHandler;
import nodomain.knu2018.gadgetbridge.database.DBHelper;
import nodomain.knu2018.gadgetbridge.deviceevents.GBDeviceEventBatteryInfo;
import nodomain.knu2018.gadgetbridge.deviceevents.GBDeviceEventCallControl;
import nodomain.knu2018.gadgetbridge.deviceevents.GBDeviceEventFindPhone;
import nodomain.knu2018.gadgetbridge.deviceevents.GBDeviceEventVersionInfo;
import nodomain.knu2018.gadgetbridge.devices.SampleProvider;
import nodomain.knu2018.gadgetbridge.devices.huami.ActivateDisplayOnLift;
import nodomain.knu2018.gadgetbridge.devices.huami.HuamiCoordinator;
import nodomain.knu2018.gadgetbridge.devices.huami.HuamiFWHelper;
import nodomain.knu2018.gadgetbridge.devices.huami.amazfitbip.AmazfitBipService;
import nodomain.knu2018.gadgetbridge.devices.huami.miband2.MiBand2FWHelper;
import nodomain.knu2018.gadgetbridge.devices.miband.DateTimeDisplay;
import nodomain.knu2018.gadgetbridge.devices.miband.DoNotDisturb;
import nodomain.knu2018.gadgetbridge.devices.miband.MiBand2SampleProvider;
import nodomain.knu2018.gadgetbridge.devices.miband.MiBand2Service;
import nodomain.knu2018.gadgetbridge.devices.miband.MiBandConst;
import nodomain.knu2018.gadgetbridge.devices.miband.MiBandCoordinator;
import nodomain.knu2018.gadgetbridge.devices.miband.MiBandService;
import nodomain.knu2018.gadgetbridge.devices.miband.VibrationProfile;
import nodomain.knu2018.gadgetbridge.devices.miband2.MiBand2Const;
...
import nodomain.knu2018.gadgetbridge.impl.GBAlarm;
import nodomain.knu2018.gadgetbridge.impl.GBDevice.State;
import nodomain.knu2018.gadgetbridge.model.ActivitySample;
import nodomain.knu2018.gadgetbridge.model.ActivityUser;
import nodomain.knu2018.gadgetbridge.model.Alarm;
import nodomain.knu2018.gadgetbridge.model.CalendarEventSpec;
import nodomain.knu2018.gadgetbridge.model.CalendarEvents;
import nodomain.knu2018.gadgetbridge.model.CallSpec;
import nodomain.knu2018.gadgetbridge.model.CannedMessagesSpec;
import nodomain.knu2018.gadgetbridge.model.DeviceService;
...
import nodomain.knu2018.gadgetbridge.service.btle.AbstractBTLEDeviceSupport;
import nodomain.knu2018.gadgetbridge.service.btle.BLETypeConversions;
import nodomain.knu2018.gadgetbridge.service.btle.BtLEAction;
import nodomain.knu2018.gadgetbridge.service.btle.GattCharacteristic;
import nodomain.knu2018.gadgetbridge.service.btle.GattService;
import nodomain.knu2018.gadgetbridge.service.btle.TransactionBuilder;
import nodomain.knu2018.gadgetbridge.service.btle.actions.AbortTransactionAction;
import nodomain.knu2018.gadgetbridge.service.btle.actions.SetDeviceStateAction;
import nodomain.knu2018.gadgetbridge.service.btle.profiles.alertnotification.AlertCategory;
import nodomain.knu2018.gadgetbridge.service.btle.profiles.deviceinfo.DeviceInfoProfile;
import nodomain.knu2018.gadgetbridge.service.btle.profiles.heartrate.HeartRateProfile;
import nodomain.knu2018.gadgetbridge.service.devices.common.SimpleNotification;
import nodomain.knu2018.gadgetbridge.service.devices.huami.HuamiDeviceEvent;
import nodomain.knu2018.gadgetbridge.service.devices.miband.NotificationStrategy;
import nodomain.knu2018.gadgetbridge.service.devices.miband.RealtimeSamplesSupport;
import nodomain.knu2018.gadgetbridge.service.devices.miband2.actions.StopNotificationAction;
import nodomain.knu2018.gadgetbridge.service.devices.miband2.operations.FetchActivityOperation;
import nodomain.knu2018.gadgetbridge.service.devices.miband2.operations.FetchSportsSummaryOperation;
import nodomain.knu2018.gadgetbridge.service.devices.miband2.operations.InitOperation;
import nodomain.knu2018.gadgetbridge.service.devices.miband2.operations.UpdateFirmwareOperation;
import nodomain.knu2018.gadgetbridge.util.GB;
import nodomain.knu2018.gadgetbridge.util.NotificationUtils;
import nodomain.knu2018.gadgetbridge.util.Prefs;
import nodomain.knu2018.gadgetbridge.util.Version;

import static nodomain.knu2018.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_COLOUR;
import static nodomain.knu2018.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_COUNT;
import static nodomain.knu2018.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_DURATION;
import static nodomain.knu2018.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_ORIGINAL_COLOUR;
import static nodomain.knu2018.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_COUNT;
import static nodomain.knu2018.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_DURATION;
import static nodomain.knu2018.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_PAUSE;
import static nodomain.knu2018.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_PROFILE;
import static nodomain.knu2018.gadgetbridge.devices.miband.MiBandConst.FLASH_COLOUR;
import static nodomain.knu2018.gadgetbridge.devices.miband.MiBandConst.FLASH_COUNT;
import static nodomain.knu2018.gadgetbridge.devices.miband.MiBandConst.FLASH_DURATION;
import static nodomain.knu2018.gadgetbridge.devices.miband.MiBandConst.FLASH_ORIGINAL_COLOUR;
import static nodomain.knu2018.gadgetbridge.devices.miband.MiBandConst.VIBRATION_COUNT;
import static nodomain.knu2018.gadgetbridge.devices.miband.MiBandConst.VIBRATION_DURATION;
import static nodomain.knu2018.gadgetbridge.devices.miband.MiBandConst.VIBRATION_PAUSE;
import static nodomain.knu2018.gadgetbridge.devices.miband.MiBandConst.VIBRATION_PROFILE;
import static nodomain.knu2018.gadgetbridge.devices.miband.MiBandConst.getNotificationPrefIntValue;
import static nodomain.knu2018.gadgetbridge.devices.miband.MiBandConst.getNotificationPrefStringValue;
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (s.equals(DeviceInfoProfile.ACTION_DEVICE_INFO)) {
                handleDeviceInfo((nodomain.knu2018.gadgetbridge.service.btle.profiles.deviceinfo.DeviceInfo) intent.getParcelableExtra(DeviceInfoProfile.EXTRA_DEVICE_INFO));
            }
        }
    };
...
//        }
    ...
    private void handleDeviceInfo(nodomain.knu2018.gadgetbridge.service.btle.profiles.deviceinfo.DeviceInfo info) {
