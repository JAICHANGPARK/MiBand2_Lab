package nodomain.knu2018.bandutils.util.AnimTextView;
 ...
 * Edited by Dreamwalker 18-06-01
 */
public class AnimaionTextViewV1 extends AppCompatTextView {

    private static final String TAG = AnimaionTextViewV1.class.getSimpleName();
    ...
    public AnimaionTextViewV1(Context context) {
        super(context);
    }

    public AnimaionTextViewV1(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AnimaionTextViewV1(Context context, AttributeSet attrs, int defStyleAttr) {
