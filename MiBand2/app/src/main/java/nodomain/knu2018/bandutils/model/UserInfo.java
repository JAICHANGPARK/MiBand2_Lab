...
public class UserInfo {
    ...
    public class Users{
        ...
        public Users(String userName, String userUUID, String phone, String gender, String age, String ageGroup, String birthday, String bsMin, String bsMax) {
            this.userName = userName;
            this.userUUID = userUUID;
            this.phone = phone;
            this.gender = gender;
        ...
        public String getBsMin() {
            return bsMin;
        }

        public void setBsMin(String bsMin) {
            this.bsMin = bsMin;
        }

        public String getBsMax() {
            return bsMax;
        }

        public void setBsMax(String bsMax) {
            this.bsMax = bsMax;
        }
