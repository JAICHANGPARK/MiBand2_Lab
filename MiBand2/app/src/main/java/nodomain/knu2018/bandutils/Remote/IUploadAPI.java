...
public interface IUploadAPI {
    ...
    //@POST("upload/upload.php")
    @Multipart
    @POST("bandutils/code/upload_backup.php")
    Call<String> backupFile(@Part MultipartBody.Part file, @Part("userUUID") RequestBody uuid);
    ...
    Call<UserInfo> updateUserInfo(@Field("userName") String name,
                                  ...
                                  @Field("age") String age,
                                  @Field("ageGroup") String ageGroup,
                                  @Field("bsMin") String bsMin,
                                  @Field("bsMax") String bsMax);
